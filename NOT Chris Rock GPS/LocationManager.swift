...
class LocationManager: NSObject,CLLocationManagerDelegate {
    ...
    private var firstLocationUpdateBlock:LMLocationCompletionHandler
    ...
    func onFirstLocationUpdateWithCompletionHandler(completionHandler:((latitude:Double, longitude:Double, status:String, verboseMessage:String, error:String?)->())? = nil){
        
        self.firstLocationUpdateBlock = completionHandler
